# Base de conhecimento — LC Odontologia
...
2. Limpeza e Prevenção — profilaxia, aplicação de flúor e orientação de higiene bucal.
3. Restaurações — tratamento de cáries com materiais estéticos de qualidade.
4. Clareamento Dental — clareamento supervisionado, resultado natural e seguro.
5. Ortodontia — aparelho metálico ou estético para alinhamento dos dentes.
6. Extrações — cirurgias simples com foco em conforto e segurança.
...
## Contato para casos complexos
Quando o visitante quiser confirmar algo que o agente não sabe, direcionar para o formulário de agendamento ou sugerir falar direto pelo WhatsApp.
