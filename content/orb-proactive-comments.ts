...
export const proactiveComments: Record<string, string> = {
  ...
  "dra-ligya": "É muito bom saber com quem estamos tratando, não é? A Dra. Ligya é reconhecida por transformar a ida ao dentista em um momento leve. Quer que eu te conte como é a primeira consulta com ela?",
  ...
  unidades: "Para facilitar a sua vida, a estrutura da Dra. Ligya está pronta para te receber em dois pontos. Me conta: onde fica melhor para encaixar no seu dia?",
